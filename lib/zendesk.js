...
class Zendesk {
  ...
  constructor(options) {
    ...
    const createMethods = (singular, plural) => {
      return {
        list: (params) => accessor(this._list(plural, params), plural),
        show: (id, params) => accessor(this._show(plural, id, params), singular),
        create: (params) => accessor(this._create(plural, {[singular]: params}), singular),
        update: (id, params) => accessor(this._update(plural, id, {[singular]: params}), singular),
        delete: (id) => this._delete(plural, id),
      };
    }
  ...
  _list(object_type, params) {
    return this._request_promisified('GET', `/${object_type}.json`,
